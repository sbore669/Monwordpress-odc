...
function shuttle_child_frontscripts() {
	...
	wp_enqueue_style( 'shuttle-style-clean', get_stylesheet_directory_uri() . '/style.css', array( 'shuttle-style' ), wp_get_theme()->get('Version') );
}
...
function shuttle_updateoption_child_settings() {
	...
	$name_options_child = 'shuttle_child_settings_clean';
	...
	if ( $options_child_settings != 1 ) {
		...
		$options_free['shuttle_styles_skin']        = 'clean';
